...
`;
  ...
  /**
   * `location = /api/storage/presigned/local`, for the vhosts generated by the
   * platform-style path (`PLATFORM_MODE`, or `PROXY_MODE` naming an external
   * SSL proxy such as a Cloudflare Tunnel).
   *
   * This used to be omitted deliberately: platform-mode workspaces run on
