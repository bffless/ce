...
- github_api: { action: "create_repo_from_template", templateOwner: "expression (e.g. bffless-templates)", templateRepo: "expression", targetOrg: "expression", repoName: "expression", private?: boolean (default true), description?: "expression", includeAllBranches?: boolean (default false) }. Creates a GitHub repo from a template. Output: { name, full_name, html_url, clone_url, default_branch }. Requires GitHub integration configured in project settings.
