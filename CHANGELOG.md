...
### Added
- ffmpeg: stream large remote-Worker inputs from the signed URL ([#797](https://github.com/bffless/ce/pull/797), thanks @toshimoto821)

### Fixed
- ffmpeg: sliced clips no longer open on a black screen when a span starts on a still frame ([#800](https://github.com/bffless/ce/pull/800), thanks @toshimoto821)
- ffmpeg: stitched videos no longer report a days-long duration ([#799](https://github.com/bffless/ce/pull/799), thanks @toshimoto821)

## [0.4.59](https://github.com/bffless/ce/compare/v0.4.58...v0.4.59) (2026-09-12)

### Fixed
- frontend: show the selected handler type label in the pipeline step picker ([#794](https://github.com/bffless/ce/pull/794), thanks @toshimoto821)
...
### Added
- pipelines: projectRole on PipelineUser — the caller's project role, resolved on every credential path ([#787](https://github.com/bffless/ce/pull/787), thanks @toshimoto821)

## [0.4.56](https://github.com/bffless/ce/compare/v0.4.55...v0.4.56) (2026-09-07)

### Fixed
- oauth: defer every OAuthModule import with forwardRef; add two review-checklist entries ([#784](https://github.com/bffless/ce/pull/784), thanks @toshimoto821)

## [0.4.55](https://github.com/bffless/ce/compare/v0.4.54...v0.4.55) (2026-09-07)

### Added
- proxy-rules: honour OUTBOUND_URL_GUARD on rules push, import and copy ([#782](https://github.com/bffless/ce/pull/782), thanks @toshimoto821)

### Fixed
- auth: unify isApiRequest so SPA fetches are never answered with a 302 ([#783](https://github.com/bffless/ce/pull/783), thanks @toshimoto821)
- proxy-rules: email form handler answers a missing session with its own 401 instead of hanging ([#781](https://github.com/bffless/ce/pull/781), thanks @toshimoto821)
- auth: stop SessionAuthGuard/ApiKeyGuard double-writing the response on a missing session ([#776](https://github.com/bffless/ce/pull/776), thanks @toshimoto821)
...
### Added
- backend: shared SSRF guard for proxy-rule targets and app bundle URLs (warn by default) ([#772](https://github.com/bffless/ce/pull/772), thanks @toshimoto821)
- oauth: rate-limit and dedupe Client ID Metadata Document fetches ([#771](https://github.com/bffless/ce/pull/771), thanks @toshimoto821)
- oauth: accept Client ID Metadata Document URLs as client_id (CIMD) ([#764](https://github.com/bffless/ce/pull/764), thanks @toshimoto821)

### Fixed
- oauth: reject a non-uuid, non-URL client_id on authorize as invalid_client ([#769](https://github.com/bffless/ce/pull/769), thanks @toshimoto821)
- pipelines: persist execution logs for in-process sibling invocations ([#763](https://github.com/bffless/ce/pull/763), thanks @toshimoto821)
...
### Added
- auth: exchange an app token for a session (POST /api/auth/session/from-app-token) ([#752](https://github.com/bffless/ce/pull/752), thanks @toshimoto821)
